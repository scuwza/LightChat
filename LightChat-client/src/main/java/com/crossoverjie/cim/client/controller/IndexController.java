package com.crossoverjie.LightChat.client.controller;
...
import com.crossoverjie.LightChat.client.vo.req.SendMsgReqVO;
import com.crossoverjie.LightChat.client.vo.req.StringReqVO;
import com.crossoverjie.LightChat.client.vo.res.SendMsgResVO;
...
public class IndexController {
    ...
    @Autowired
    private LightChatClient heartbeatClient ;
    ...
    @RequestMapping(value = "sendStringSingleMsg", method = RequestMethod.POST)
    @ResponseBody
    public BaseResponse<NULLBody> sendStringSingleMsg(@RequestBody StringReqVO stringReqVO){
        BaseResponse<NULLBody> res = new BaseResponse();
