...
import com.crossoverjie.LightChat.client.handle.MsgHandleCaller;
import com.crossoverjie.LightChat.client.service.impl.MsgCallBackListener;
...
public class BeanConfig {
    ...
    @Value("${LightChat.callback.thread.queue.size}")
    private int queueSize;

    @Value("${LightChat.callback.thread.pool.size}")
    ...
    public LightChatRequestProto.LightChatReqProtocol heartBeat() {
        LightChatRequestProto.LightChatReqProtocol heart = LightChatRequestProto.LightChatReqProtocol.newBuilder()
                .setRequestId(userId)
                .setReqMsg("ping")
