package com.crossoverjie.LightChat.server.test;
...
public class CommonTest {
    ...
    public void test() {
        ...
        LightChatServerResVO LightChatServerResVO = JSON.parseObject(json, LightChatServerResVO.class);

        System.out.println(LightChatServerResVO.toString());
    ...
    public void searchMsg(){
        ...
        String allMsg = "于是在之前的基础上我完善了一些内容，先来看看这个项目的介绍吧：\n" +
                "\n" +
                "LightChat(CROSS-IM) 一款面向开发者的 IM(即时通讯)系统；同时提供了一些组件帮助开发者构建一款属于自己可水平扩展的 IM 。\n" +
                "\n" +
                "借助 LightChat 你可以实现以下需求：" ;
    ...
    public void log(){
        ...
        String dir = "/opt/logs/LightChat/zhangsan" + "/";
