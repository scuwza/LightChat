package com.crossoverjie.LightChat.server.util;
...
public class SessionSocketHolder {
     ...
     * @return
     */
    public static LightChatUserInfo getUserId(NioSocketChannel nioSocketChannel){
        for (Map.Entry<Long, NioSocketChannel> entry : CHANNEL_MAP.entrySet()) {
            ...
            if (nioSocketChannel == value){
                ...
                LightChatUserInfo info = new LightChatUserInfo(key,userName) ;
                return info ;
            }
        }
