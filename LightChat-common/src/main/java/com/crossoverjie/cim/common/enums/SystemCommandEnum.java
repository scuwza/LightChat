package com.crossoverjie.LightChat.common.enums;
...
public enum SystemCommandEnum {
    ...
    public static Map<String,String> getAllClazz() {
        Map<String,String> map = new HashMap<String, String>(16) ;
        for (SystemCommandEnum status : values()) {
            map.put(status.getCommandType().trim(),"com.crossoverjie.LightChat.client.service.impl.command." + status.getClazz()) ;
        }
        return map;
    }
