package com.crossoverjie.LightChat.common.route.algorithm.consistenthash;

import com.crossoverjie.LightChat.common.data.construct.SortArrayMap;
...
public class SortArrayMapConsistentHash extends AbstractConsistentHash {
    ...
    public void add(long key, String value) {
        // fix https://github.com/crossoverJie/LightChat/issues/79
        sortArrayMap.clear();
