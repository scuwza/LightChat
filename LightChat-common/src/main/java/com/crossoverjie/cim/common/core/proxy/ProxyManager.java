package com.crossoverjie.LightChat.common.core.proxy;

import com.alibaba.fastjson.JSONObject;
import com.crossoverjie.LightChat.common.exception.LightChatException;
import com.crossoverjie.LightChat.common.util.HttpClient;
...
public final class ProxyManager<T> {
    ...
    private class ProxyInvocation implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            // method: Object login(LoginReqVO loginReqVO)
            ...
            if (method.getParameterTypes().length > 0){
                Object para = args[0]; // LoginReqVO loginReqVO
                Class<?> parameterType = method.getParameterTypes()[0];  // LoginReqVO.class
                for (Field field : parameterType.getDeclaredFields()) {
                    field.setAccessible(true);
                    jsonObject.put(field.getName(), field.get(para)); // {userId, loginReqVO.userId}
                }
            }
